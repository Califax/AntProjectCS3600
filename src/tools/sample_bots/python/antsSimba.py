...
class Ants():
    def __init__(self):
        ...
        self.turns = 0
        self.directionList = []
        self.orders = False # Start without orders
    ...
    def update(self, data):
     ...
     # Update food
        ...
        for pos in self.food_list:
            if self.visible(pos):
                self.map[pos[0]][pos[1]] = LAND
            else:
                # Assume still there
                new_food.append(pos)
                
        for pos in self.visible_food_list:
            self.map[pos[0]][pos[1]] = FOOD
    ...
    def hasOrders(self):
        return orders # True if the ant has orders
    
    def setOrders(self, bool):
        self.orders = bool
    
    def setOrderList(self, directList):
        self.directionList = directList
